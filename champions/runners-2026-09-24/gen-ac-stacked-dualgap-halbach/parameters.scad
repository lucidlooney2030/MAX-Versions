// =============================================================================
// Gen-AC Stacked dual-gap / mid-stator Halbach intensifier — WOUND-AWARE
// TWO wound pancake stators | ONE mid dual-face Halbach rotor | outer endbells
// Beats Gen-Z: thinner m2m, larger copper window, 125 t / coil
// =============================================================================

wire_awg            = 26;
wire_od             = 0.45;
turns               = 125;      // 9 coils/stator ×2 = 18 ×125 ×~0.115 ≈ 259 m
fill                = 0.70;
layers_per_face     = 2;
wind_build_axial    = layers_per_face * wire_od * fill;   // 0.63
wind_build_radial   = 2.8 * wire_od * fill;               // 0.882

coil_id_r           = 21.0;     // larger than Gen-Z 22–58
coil_od_r           = 60.0;
...
m2m                 = coil_envelope_h + 2 * run_clear;      // 5.46 per gap (beats Gen-Z 5.86)
