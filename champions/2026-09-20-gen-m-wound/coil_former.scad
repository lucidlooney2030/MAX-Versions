// Gen-M pancake former — print ×18 (9 per stator)
// WOUND BUDGET: 26 AWG wire_od=0.45, turns=120, fill=0.7
// wind_build_axial = 3 * 0.45 * 0.7 = 0.945 mm each face
// coil_envelope_h = former_web + 2*flange_t + 2*wind_build_axial = 7.09 mm
