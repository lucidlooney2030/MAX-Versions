// =============================================================================
// Gen-AA Vernier flux-claw dual nano-gap — WOUND-AWARE (HARD GATE)
// Improve Gen-X: tighter m2m ≤6.4, more copper (145 t), run_clear 0.70
// =============================================================================

wire_awg            = 26;
wire_od             = 0.45;
turns               = 145;      // +10 vs Gen-X 135
fill                = 0.70;
layers_per_face     = 2;
...
run_clear           = 0.70;
gap_spacer_h        = run_clear + wind_build_axial;         // 1.33
m2m                 = coil_envelope_h + 2 * run_clear;      // 6.16 (beats Gen-X 6.76; ≤6.4 target)
