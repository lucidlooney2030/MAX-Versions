// =============================================================================
// Gen-Z Dual-stator mid-rotor Halbach sandwich — WOUND-AWARE (HARD GATE)
// ONE mid rotor (magnets both faces) | TWO wound pancake stators | outer endbells
// =============================================================================

wire_awg            = 26;
wire_od             = 0.45;
turns               = 115;      // 9 coils/stator ×2 = 18 ×115 ×~0.11 ≈ 228 m
fill                = 0.70;
layers_per_face     = 2;
...
former_bare_h       = former_web + 2 * flange_t;            // 3.3
coil_envelope_h     = former_bare_h + 2 * wind_build_axial; // 4.56

run_clear           = 0.65;
gap_spacer_h        = run_clear + wind_build_axial;         // 1.28
m2m                 = coil_envelope_h + 2 * run_clear;      // 5.86 per gap
