// Gen-AB rotor face B — pockets +rotor_b_offset_deg vs A; print ×1
// DUAL-ROTOR CLAP: brace with M4 rods BEFORE approaching this face
...
module small_halbach() {
    for (i = [0 : large_n-1]) {
        a = i * 360 / large_n + 180/large_n + rotor_b_offset_deg;
