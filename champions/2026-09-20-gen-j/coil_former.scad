// Gen-J pancake former — print ×18 (9 per stator); wider for 40° pitch; 26 AWG ~120–160 t
coil_id_r = 24.0; coil_od_r = 56.0; span_deg = 34.0;
flange_t = 1.0; core_t = 3.2; wall = 1.0; slot_w = 2.4;
mount_hole = 3.5; tab_len = 7.0; $fn = 48;
...
module flange() { linear_extrude(flange_t) offset(r=wall) sector_2d(coil_id_r, coil_od_r, span_deg); }
difference() {
    union() {
        flange();
    ...
    translate([coil_od_r - 2, -slot_w/2, flange_t]) cube([wall + 4, slot_w, core_t + 0.1]);
