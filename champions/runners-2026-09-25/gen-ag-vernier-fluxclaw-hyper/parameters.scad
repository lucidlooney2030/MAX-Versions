// =============================================================================
// Gen-AG Vernier flux-claw hyper-nano — WOUND-AWARE (HARD GATE)
// Improve Gen-AG: tighter m2m 5.11, more copper (165 t), run_clear 0.55
// =============================================================================

wire_awg            = 26;
wire_od             = 0.45;
turns               = 165;      // +10 vs Gen-AG 155
fill                = 0.70;
layers_per_face     = 2;
...
m2m                 = coil_envelope_h + 2 * run_clear;      // 5.11 (beats Gen-AG 5.46)
